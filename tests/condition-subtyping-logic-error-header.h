...
extern void cce_descriptor_set_parent_to(my_descriptor_logic_error_subtype_t) (cce_descriptor_t * const D)
...
extern bool my_condition_is_logic_error_subtype (cce_condition_t const * C)
