...
extern void cce_descriptor_set_parent_to(my_descriptor_invalid_argument_subtype_t) (cce_descriptor_t * const D)
...
extern bool my_condition_is_invalid_argument_subtype (cce_condition_t const * C)
