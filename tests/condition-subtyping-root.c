...
#include "condition-subtyping-root.h"
#include <stdio.h>
#include <stdlib.h>
...
static cce_condition_delete_fun_t		my_condition_delete_root_subtype;
...
static my_descriptor_root_subtype_t my_descriptor_root_subtype = {
  ...
  .descriptor.delete		= my_condition_delete_root_subtype,
  .descriptor.final		= my_condition_final_root_subtype,
  .descriptor.static_message	= my_condition_static_message_root_subtype
};

void
cce_descriptor_set_parent_to(my_descriptor_root_subtype_t) (cce_descriptor_t * const D)
{
  D->parent = cce_descriptor_pointer(my_descriptor_root_subtype);
}
...
void
my_condition_delete_root_subtype (cce_condition_t * _C)
...
char const *
my_condition_static_message_root_subtype (cce_condition_t const * C CCLIB_UNUSED)
{
