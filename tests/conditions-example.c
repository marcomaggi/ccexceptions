...
{
  return cce_is_condition(condition, my_condition_D(&alpha_D));
}
...
{
  return cce_is_condition(condition, my_condition_D(&beta_D));
}
...
{
  return cce_is_condition(condition, my_condition_D(&gamma_D));
}
