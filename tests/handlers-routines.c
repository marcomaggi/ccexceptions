...
main (int argc CCE_UNUSED, const char *const argv[] CCE_UNUSED)
{
  /* Just run cleanup handlers. */
  {
    ...
    void handler1 (const cce_condition_C_t * C CCE_UNUSED, cce_handler_t * H CCE_UNUSED) {
      flag1 = true;
    }
    void handler2 (const cce_condition_C_t * C CCE_UNUSED, cce_handler_t * H CCE_UNUSED) {
      flag2 = true;
    }
    void handler3 (const cce_condition_C_t * C CCE_UNUSED, cce_handler_t * H CCE_UNUSED) {
      flag3 = true;
    }
  ...
  /* Allocating memory: success execution path. */
  {
    ...
    void P_handler (const cce_condition_C_t * C CCE_UNUSED, cce_handler_t * H CCE_UNUSED) {
      free(P);
      flag = true;
    }
