...
#include "condition-subtyping-break-header.h"
#include <stdio.h>
#include <stdlib.h>
...
static ccname_method_type(cce_condition_t, release)		my_condition_release_break_subtype;
static ccname_method_type(cce_condition_t, final)		my_condition_final_break_subtype;
static ccname_method_type(cce_condition_t, static_message)	my_condition_static_message_break_subtype;
...
static my_descriptor_break_subtype_t my_descriptor_break_subtype_stru = {
  ...
  .descriptor.release		= my_condition_release_break_subtype,
...
void
my_condition_release_break_subtype (cce_condition_t * _C)
...
char const *
my_condition_static_message_break_subtype (cce_condition_t const * C CCE_UNUSED)
{
 ...
 */
{
  ccname_init(cce_condition_t, break)(&(C->parent));
 ...
 */
{
  ...
  if (cce_location(L)) {
    ...
    ccname_init(cce_condition_t)((cce_condition_t *) C, &(my_descriptor_break_subtype_ptr->descriptor));
