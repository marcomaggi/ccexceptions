...
#include "condition-subtyping-error-header.h"
#include <stdio.h>
#include <stdlib.h>
...
static cce_condition_delete_fun_t		my_condition_delete_error_subtype;
static cce_condition_final_fun_t		my_condition_final_error_subtype;
static cce_condition_static_message_fun_t	my_condition_static_message_error_subtype;

static my_descriptor_error_subtype_t my_descriptor_error_subtype = {
...
void
cce_descriptor_set_parent_to(my_descriptor_error_subtype_t) (cce_descriptor_t * const D)
{
  D->parent = cce_descriptor_pointer(my_descriptor_error_subtype);
}
...
char const *
my_condition_static_message_error_subtype (cce_condition_t const * C CCLIB_UNUSED)
{
...
void
my_condition_init_error_subtype (cce_destination_t L, my_condition_error_subtype_t * C, int the_data)
 ...
 */
{
  cce_condition_init_error(&(C->error));
...
my_condition_new_error_subtype (cce_destination_t upper_L, int the_data)
/* This constructor function is the  public interface to the constructor
 * of condition objects of type "my_condition_error_subtype_t".
 *
 * Here we:
 *
 ...
 */
{
  ...
  if (cce_location(L)) {
    ...
    my_condition_error_subtype_t * C = cce_sys_malloc_guarded(L, C_H, sizeof(my_condition_error_subtype_t));

    cce_condition_init((cce_condition_t *) C, cce_descriptor_pointer(my_descriptor_error_subtype));
    my_condition_init_error_subtype(L, C, the_data);
...
bool
my_condition_is_error_subtype (cce_condition_t const * C)
{
  return cce_condition_is(C, cce_descriptor_pointer(my_descriptor_error_subtype));
}
...
{
  cce_descriptor_set_parent_to(cce_descriptor_error_t)(cce_descriptor_pointer(my_descriptor_error_subtype));
}
