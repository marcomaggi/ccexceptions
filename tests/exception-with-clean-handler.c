...
static void
handler1 (cce_condition_t const * const C CCLIB_UNUSED, cce_clean_handler_t const * const H)
{
...
static void
handler2 (cce_condition_t const * const C CCLIB_UNUSED, cce_clean_handler_t const * const H)
{
  bool	* flagp = cce_handler_resource_pointer(H);
