...
#include "condition-subtyping-unimplemented.h"
#include <stdio.h>
#include <stdlib.h>
...
static my_descriptor_unimplemented_subtype_t my_descriptor_unimplemented_subtype = {
...
void
cce_descriptor_set_parent_to(my_descriptor_unimplemented_subtype_t) (cce_descriptor_t * const D)
{
  D->parent = cce_descriptor_pointer(my_descriptor_unimplemented_subtype);
}
 ...
 */
{
  ...
  if (cce_location(L)) {
    ...
    cce_condition_init((cce_condition_t *) C, cce_descriptor_pointer(my_descriptor_unimplemented_subtype));
...
{
  return cce_condition_is(C, cce_descriptor_pointer(my_descriptor_unimplemented_subtype));
}
...
{
  cce_descriptor_set_parent_to(cce_descriptor_unimplemented_t)(cce_descriptor_pointer(my_descriptor_unimplemented_subtype));
}
