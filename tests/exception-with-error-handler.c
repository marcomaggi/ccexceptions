...
main (void)
{
  /* no exception */
  {
    ...
    if (cce_location(L)) {
      ...
      cce_init_error_handler(H1, (void *)&flag1, handler1);
      cce_init_error_handler(H2, (void *)&flag2, handler2);
  ...
  /* raise an exception */
  {
    ...
    if (cce_location(L)) {
      ...
      cce_init_error_handler(H1, &flag1, handler1);
      cce_init_error_handler(H2, &flag2, handler2);
