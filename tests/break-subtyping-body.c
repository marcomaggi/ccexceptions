...
void
my_condition_init_break_subtype (my_condition_break_subtype_t * C, int the_data)
...
my_condition_new_break_subtype (cce_destination_t L, int the_data)
   ...
   descriptor field; then we call the initialisation function. */
{
  ...
  my_condition_init_break_subtype(C, the_data);
