...
#define cce_init_handler(...)	_CCLIB_VFUNC(cce_init_handler,__VA_ARGS__)
...
#define cce_init_and_register_handler(...)	_CCLIB_VFUNC(cce_init_and_register_handler,__VA_ARGS__)
