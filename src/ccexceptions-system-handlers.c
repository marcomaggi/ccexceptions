...
void
cce_cleanup_handler_filedes_init (cce_location_t * L, cce_handler_t * H, int filedes)
{
...
void
cce_error_handler_filedes_init (cce_location_t * L, cce_handler_t * H, int filedes)
{
  H->function	= cce_handler_filedes_function;
  H->filedes	= filedes;
  cce_register_error_handler(L, H);
...
void
cce_cleanup_handler_pipedes_init (cce_location_t * L, cce_handler_t * H, int pipedes[2])
{
...
void
cce_error_handler_pipedes_init (cce_location_t * L, cce_handler_t * H, int pipedes[2])
{
  H->function	= cce_handler_pipedes_function;
  H->pipedes[0]	= pipedes[0];
  H->pipedes[1]	= pipedes[1];
...
void
cce_cleanup_handler_tmpfile_init (cce_location_t * L, cce_handler_t * H, const char * pathname)
{
...
void
cce_error_handler_tmpfile_init (cce_location_t * L, cce_handler_t * H, const char * pathname)
{
  size_t	len = 1+strlen(pathname);
  char *	ptr = cce_sys_malloc(L, len);
  strncpy(ptr, pathname, len);
...
void
cce_cleanup_handler_tmpdir_init (cce_location_t * L, cce_handler_t * H, const char * pathname)
{
  size_t	len = 1+strlen(pathname);
  char *	ptr = cce_sys_malloc(L, len);
  strncpy(ptr, pathname, len);
...
void
cce_error_handler_tmpdir_init (cce_location_t * L, cce_handler_t * H, const char * pathname)
{
  size_t	len = 1+strlen(pathname);
  char *	ptr = cce_sys_malloc(L, len);
  strncpy(ptr, pathname, len);
...
void
cce_cleanup_handler_dirstream_init (cce_location_t * L, cce_handler_t * H, DIR * dirstream)
{
...
void
cce_error_handler_dirstream_init (cce_location_t * L, cce_handler_t * H, DIR * dirstream)
{
  H->function	= cce_handler_dirstream_function;
  H->pointer	= dirstream;
  cce_register_error_handler(L, H);
